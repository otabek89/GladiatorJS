...
The Emperor has commissioned you to build a Gladiator Arena. You will do so using your knowledge of object-oriented Javascript.
...
Create a `Gladiator` constructor function that has the following properties...
- a `name`
...
Create an `Arena` constructor function that meets the following criteria...
